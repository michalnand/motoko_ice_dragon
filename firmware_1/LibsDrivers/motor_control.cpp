...
{
    return -left_encoder.position*2.0*PI/ENCODER_RESOLUTION;
}

float MotorControl::get_left_position_fil()
{
    return -left_encoder.position_fil*2.0*PI/ENCODER_RESOLUTION;
}
...
{
    return right_encoder.position*2.0*PI/ENCODER_RESOLUTION;
} 
...
{
    return right_encoder.angular_velocity*2.0*PI/ENCODER_RESOLUTION;
}
